...
For the action, to move to another tile say : move X (you can chose up - NORTH, SOUTH, EAST, WEST, STAY)
...
Teamates messages: *message*
Roles: *Player Omega is yellow*
...
Role: As Delta player, you are red.\
...
Your role: You are playing as Player red at (0,2) Current round : 0; Total team score : 0; Observation: laser beam yellow at (2,0) and projects a beam horizontally across the entire row 2. diamond at (4,0). Exit tile at (4,3) and (4,4); Roles: Omega is Yellow; Teamates location:(0,3); Teammates messages: '' Avalaible: WEST, SOUTH"
